...
<head>
    ...
    <title><?= $title ?? 'Sửa khách hàng' ?></title>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="p-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="<?= BASE_URL ?>/admin/customers/update/<?= $customer['id'] ?>" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control <?= isset($_SESSION['errors']['ho_ten']) ? 'is-invalid' : '' ?>" 
                                                   ...
                                                   value="<?= htmlspecialchars($_SESSION['old_data']['ho_ten'] ?? $customer['ho_ten']) ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control <?= isset($_SESSION['errors']['email']) ? 'is-invalid' : '' ?>" 
                                                   id="email" name="email" 
                                                   value="<?= htmlspecialchars($_SESSION['old_data']['email'] ?? $customer['email']) ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control <?= isset($_SESSION['errors']['so_dien_thoai']) ? 'is-invalid' : '' ?>" 
                                                   ...
                                                   value="<?= htmlspecialchars($_SESSION['old_data']['so_dien_thoai'] ?? $customer['so_dien_thoai']) ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control <?= isset($_SESSION['errors']['ngay_sinh']) ? 'is-invalid' : '' ?>" 
                                                   ...
                                                   value="<?= htmlspecialchars($_SESSION['old_data']['ngay_sinh'] ?? $customer['ngay_sinh']) ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-text">Chọn file ảnh mới để thay đổi (JPG, PNG, GIF)</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="trang_thai" name="trang_thai">
                                                <option value="active" <?= ($_SESSION['old_data']['trang_thai'] ?? $customer['trang_thai']) == 'active' ? 'selected' : '' ?>>
                                                    Hoạt động
                                                </option>
                                                <option value="inactive" <?= ($_SESSION['old_data']['trang_thai'] ?? $customer['trang_thai']) == 'inactive' ? 'selected' : '' ?>>
                                                    Không hoạt động
                                                </option>
                                            </select>
                                        </div>
